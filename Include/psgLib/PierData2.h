...
public:
   ...
   // Sets the number of columns... if the column count increases, the new columns
...
private:
   ...
   HRESULT LoadOldPierData(Float64 version,IStructuredLoad* pStrLoad,std::shared_ptr<IEAFProgress> pProgress,const std::_tstring& strUnitName);

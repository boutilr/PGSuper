...
public:
   ...
   void OnHaunchDepthTypeChanged();

   // Function to make sure haunch depths in bridge, span, segments... remain compatible with current dialog settings
   static void NormalizeHaunchDepths(std::vector<Float64>& rDepths,pgsTypes::HaunchInputDistributionType disttype,const CBridgeDescription2* pBridgeDesc);

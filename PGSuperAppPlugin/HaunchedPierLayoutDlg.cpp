...
// HaunchedPierLayoutDlg.cpp : implementation file
//
...
CHaunchedPierLayoutDlg::CHaunchedPierLayoutDlg(CWnd* pParent)
    :CDialog(IDD_PIER_LAYOUT_HAUNCHED, pParent)
{
...
// Add to message map
BEGIN_MESSAGE_MAP(CHaunchedPierLayoutDlg, CDialog)
    ON_MESSAGE(WM_USER + 100, OnColumnGridCellChanged)

    ON_CBN_SELCHANGE(IDC_HEIGHT_MEASURE, OnHeightMeasureChanged)
    ON_BN_CLICKED(IDC_ADD_COLUMN, &CHaunchedPierLayoutDlg::OnAddColumn)
    ON_BN_CLICKED(IDC_REMOVE_COLUMN, &CHaunchedPierLayoutDlg::OnRemoveColumns)

    ON_EN_CHANGE(IDC_W, &CHaunchedPierLayoutDlg::OnPierLayoutChanged)
    ON_EN_CHANGE(IDC_H1, &CHaunchedPierLayoutDlg::OnPierLayoutChanged)
    ON_EN_CHANGE(IDC_H2, &CHaunchedPierLayoutDlg::OnPierLayoutChanged)
    ON_EN_CHANGE(IDC_H3, &CHaunchedPierLayoutDlg::OnPierLayoutChanged)
    ON_EN_CHANGE(IDC_H4, &CHaunchedPierLayoutDlg::OnPierLayoutChanged)
    ON_EN_CHANGE(IDC_X1, &CHaunchedPierLayoutDlg::OnPierLayoutChanged)
    ON_EN_CHANGE(IDC_X2, &CHaunchedPierLayoutDlg::OnPierLayoutChanged)
    ON_EN_CHANGE(IDC_X3, &CHaunchedPierLayoutDlg::OnPierLayoutChanged)
    ON_EN_CHANGE(IDC_X4, &CHaunchedPierLayoutDlg::OnPierLayoutChanged)
    ON_EN_CHANGE(IDC_X5, &CHaunchedPierLayoutDlg::OnPierLayoutChanged)
    ON_EN_CHANGE(IDC_X6, &CHaunchedPierLayoutDlg::OnPierLayoutChanged)

    ON_CBN_SELCHANGE(IDC_REFCOLUMN, &CHaunchedPierLayoutDlg::OnRefColumnChanged)
    ON_EN_CHANGE(IDC_REFCOLUMN_OFFSET, &CHaunchedPierLayoutDlg::OnRefColumnChanged)
    ON_CBN_SELCHANGE(IDC_REFCOLUMN_MEASUREMENT, &CHaunchedPierLayoutDlg::OnRefColumnChanged)
...
void CHaunchedPierLayoutDlg::OnLButtonDown(UINT nFlags, CPoint point)
{
    CRect rcControl;
...
void CHaunchedPierLayoutDlg::OnLButtonUp(UINT nFlags, CPoint point)
{
    CRect rcControl;
    m_ctrlDrawXBeam.GetWindowRect(&rcControl);
    ScreenToClient(&rcControl);
...
void CHaunchedPierLayoutDlg::OnMouseMove(UINT nFlags, CPoint point)
{
    CRect rcControl;
    m_ctrlDrawXBeam.GetWindowRect(&rcControl);
    ScreenToClient(&rcControl);
...
void CHaunchedPierLayoutDlg::OnLButtonDblClk(UINT nFlags, CPoint point)
{
    CRect rcControl;
    m_ctrlDrawXBeam.GetWindowRect(&rcControl);
    ScreenToClient(&rcControl);
...
/////////////////////////////////////////////////////////////////////////////
// CHaunchedPierLayoutDlg message handlers

BOOL CHaunchedPierLayoutDlg::OnInitDialog()
{
...
void CHaunchedPierLayoutDlg::DoDataExchange(CDataExchange* pDX)
{
...
void CHaunchedPierLayoutDlg::RefreshDisplay()
{
...
void CHaunchedPierLayoutDlg::FillTransverseLocationComboBox()
{
...
void CHaunchedPierLayoutDlg::FillRefColumnComboBox(ColumnIndexType nColumns)
{
...
void CHaunchedPierLayoutDlg::FillHeightMeasureComboBox()
{
...
void CHaunchedPierLayoutDlg::OnHeightMeasureChanged()
{
    CComboBox* pcbHeightMeasure = (CComboBox*)GetDlgItem(IDC_HEIGHT_MEASURE);
...
LRESULT CHaunchedPierLayoutDlg::OnColumnGridCellChanged(WPARAM wParam, LPARAM lParam)
{
...
void CHaunchedPierLayoutDlg::OnAddColumn()
{
...
void CHaunchedPierLayoutDlg::OnRemoveColumns()
{
...
void CHaunchedPierLayoutDlg::SetPierModelType(const pgsTypes::PierModelType& pierModelType)
{
...
void CHaunchedPierLayoutDlg::OnPierLayoutChanged()
{
...
void CHaunchedPierLayoutDlg::OnRefColumnChanged()
{
    // Get the current values from the edit controls into member variables
    CDataExchange dx(this, TRUE);

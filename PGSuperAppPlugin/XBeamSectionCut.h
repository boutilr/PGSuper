...
class iXBeamSectionCutDrawStrategy
{
public:
	virtual void Init(PierIndexType pierIdx, std::shared_ptr<WBFL::DManip::iPointDisplayObject> pDO, CXBeamCutLocation* pCutLoc) = 0;
	virtual void SetColor(COLORREF color) = 0;
};


class CXBeamSectionCutDisplayImpl :
   public iXBeamSectionCutDrawStrategy,
   public WBFL::DManip::iDrawPointStrategy, 
   public WBFL::DManip::iDisplayObjectEvents, 
   public WBFL::DManip::iDragData
{
public:
   CXBeamSectionCutDisplayImpl();
   ~CXBeamSectionCutDisplayImpl();

   // iSectionCutStrategy
   void Init(PierIndexType pierIdx, std::shared_ptr<WBFL::DManip::iPointDisplayObject> pDO, CXBeamCutLocation* pCutLoc) override;
...
private:
   ...
   CXBeamCutLocation*      m_pCutLocation;
